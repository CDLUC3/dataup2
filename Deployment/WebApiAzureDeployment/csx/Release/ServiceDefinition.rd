...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="WebApiAzureDeployment" generation="1" functional="0" release="0" Id="b667e2cb-db17-4285-9b7f-a6476d94bf60" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="WebApiAzureDeploymentGroup" generation="1" functional="0" release="0">
      <componentports>
        <inPort name="WebApi:dataup2httpsin" protocol="https">
          <inToChannel>
      ...
      <settings>
        <aCS name="Certificate|WebApi:dataup2cert" defaultValue="">
          <maps>
            <mapMoniker name="/WebApiAzureDeployment/WebApiAzureDeploymentGroup/MapCertificate|WebApi:dataup2cert" />
          </maps>
        </aCS>
      ...
      <maps>
        <map name="MapCertificate|WebApi:dataup2cert" kind="Identity">
          <certificate>
            <certificateMoniker name="/WebApiAzureDeployment/WebApiAzureDeploymentGroup/WebApi/dataup2cert" />
          </certificate>
        </map>
      ...
      <components>
        ...
        <groupHascomponents>
          <role name="WebApi" generation="1" functional="0" release="0" software="C:\DataOnboarding\Deployment\WebApiAzureDeployment\csx\Release\roles\WebApi" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaIISHost.exe " memIndex="7168" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
            ...
            <storedcertificates>
              <storedCertificate name="Stored0dataup2cert" certificateStore="My" certificateLocation="System">
                <certificate>
                  <certificateMoniker name="/WebApiAzureDeployment/WebApiAzureDeploymentGroup/WebApi/dataup2cert" />
                </certificate>
              </storedCertificate>
  ...
  <implements>
    <implementation Id="26947fa2-7982-4198-a5c6-4bf7487ae3df" ref="Microsoft.RedDog.Contract\ServiceContract\WebApiAzureDeploymentContract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="9b74401f-25b7-4122-8552-0b7fa4c999f6" ref="Microsoft.RedDog.Contract\Interface\WebApi:dataup2httpsin@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/WebApiAzureDeployment/WebApiAzureDeploymentGroup/WebApi:dataup2httpsin" />
          </inPort>
        </interfaceReference>
